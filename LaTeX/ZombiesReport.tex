...
Since the determinant of the matrix is zero, one of the eigenvalues must also be zero. The zero eigenvalue corresponds to a direction in which disruptions to the population do not get restored to the fixed point or blown up. 

\textcolor{red}{Note to self: I don't think this is quite right here}

\subsection{Eigenvalues}

\textcolor{red}{I think this section needs some fixing, I'm not sure what I've fucked up.}
...
\textcolor{red}{Note to self: Simplify the quads a bit too many zeros!}
