...
\includegraphics[width=0.9\linewidth, height=6cm]{Figures/Org/del,0.05/TrD} 
\caption{$\lambda = 0.05$}
\end{subfigure}
\begin{subfigure}{0.45\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Figures/Org/del,0.5/TrD}
\caption{$\lambda = 0.5$}
\end{subfigure}
...
\includegraphics[width=0.9\linewidth, height=4cm]{Figures/Org/del,0.05/HCphase} 
\caption{$\lambda = 0.05$}
\end{subfigure}
\begin{subfigure}{0.315\textwidth}
\includegraphics[width=0.9\linewidth, height=4cm]{Figures/Org/del,0.5/HCphase}
\caption{$\lambda = 0.5$}
\end{subfigure}
\begin{subfigure}{0.315\textwidth}
\includegraphics[width=0.9\linewidth, height=4cm]{Figures/Org/del,1/HCphase}
\caption{$\lambda = 1$}
\end{subfigure}
...
\begin{figure}[H]
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Figures/Org/del,0.5/HCphase}
\caption{No alpha, $\lambda = 0.5$}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{Figures/Alt1/del,0.5/HCph,al,0.1}
\caption{$\lambda = 0.5, \alpha = 0.1$}
\end{subfigure}
